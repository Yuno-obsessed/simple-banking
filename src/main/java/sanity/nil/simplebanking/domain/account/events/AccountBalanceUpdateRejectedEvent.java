...
/*
    When account's balance failed updating after transaction
 */
public class AccountBalanceUpdateRejectedEvent implements Event, Serializable {
    ...
    public AccountBalanceUpdateRejectedEvent(Account account, Transaction transaction) {
        this.baseEvent = new BaseEvent("AccountBalanceUpdateRejected");
